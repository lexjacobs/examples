...
sleepy.keymap({
    ...
    'dragon wake': [lambda m: set_enabled(False), lambda m: engine.mimic('wake up'.split())],
    'talon wake': [lambda m: set_enabled(True), lambda m: engine.mimic('go to sleep'.split())],
})
sleep_group.load()
