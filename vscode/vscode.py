...
ctx.keymap(
    {
        ...
        "snip line": [vscode_command("cursorLineStart", "deleteAllRight")],
        "snip line super": vscode_command("editor.action.deleteLines"),
        "snip right": vscode_command("deleteAllRight"),
        "snip left": vscode_command("deleteAllLeft"),
        "drag up": vscode_command("editor.action.moveLinesUpAction"),
        "drag down": vscode_command("editor.action.moveLinesDownAction"),
        "copy line": vscode_command("editor.action.copyLinesDownAction"),
        "go back": vscode_command("workbench.action.navigateBack"),
        "go forward": vscode_command("workbench.action.navigateForward"),
