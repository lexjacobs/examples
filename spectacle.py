...
keymap = {
    ...
    'wendy middle': [Key('cmd-ctrl-alt-f3'), Key('cmd-ctrl-alt-f4'), Key('cmd-ctrl-alt-f8'), Key('cmd-ctrl-alt-f8'), Key('cmd-ctrl-alt-f8'), Key('cmd-ctrl-alt-f8'), Key('cmd-ctrl-alt-f8'), Key('cmd-ctrl-alt-f8'), Key('cmd-ctrl-alt-f8'), Key('cmd-ctrl-alt-f8'), Key('cmd-ctrl-alt-f8'), Key('cmd-ctrl-alt-f8'), Key('cmd-ctrl-alt-f8')],
